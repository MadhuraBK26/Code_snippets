...
array(
'question_text' => '3.Which of the following type of class allows only one object of it to be created?',
'answer_text' => '(1)Abstract class',
'correct_answer' => false,
'ans_text' => '(2)Singleton class',
'cor_answer' =>true,
...
<form  method="POST" action="a11.php?question=<?php
if (!isset($question1[$_GET['question']]))
{
	
   //echo $question1[$_GET['question[0]']] ;
   //var_dump ($question1[$_GET['question']]);
    echo $question1[$_GET['question']] =0;
    	
    
}
else //(isset($question1[$_GET['question']]))
    echo $question1[$_GET['question']] +1;	
