...
$question1 = array(
    ...
    array(
        'question_text' => ' Which of the following is not a type of constructor',
    ...
    array(
        'question_text' => 'Which of the following type of class allows only one object of it to be created?',
...
//print_r($question1);
/*$question2=(array(array('question_text')));
...
<form  method="POST" action="assessment5.php?question=<?php
echo $input + 1;
?>">
