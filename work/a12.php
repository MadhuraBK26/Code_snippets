<?php
session_start();
$_SESSION['question']=$question1[$_GET['question']];
?>
...
<form  method="POST" action="a10.php">
...
<html>
<h2 align="center">Multiple choice questions form</h2>
<form  method="POST" action="a12.php?question=
...
if (!isset($_SESSION['question']))
{
    ...
    $_SESSION[$question1[$_GET['question']]] = 0;
    var_dump ($question1[$_GET['question']]);
    echo $_SESSION[$question1[$_GET['question']]] +1;
}?>">
<?php
