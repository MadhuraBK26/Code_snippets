...
<?php
 ...
 /* echo" <i><b>2.Which of the following is not a type of constructor?<br></b></i></td>";
 echo" <input type='radio' name='name' value='Copy constructor' >Copy constructor <br>";
 echo" <input type='radio' name='name' value='Friend constructor' >Friend constructor <br> ";
echo"  <input type='radio' name='name' value='Friend class' >Friend class <br>";
